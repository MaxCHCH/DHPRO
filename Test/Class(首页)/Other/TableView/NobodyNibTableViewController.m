...
- (void)viewDidLoad {
	...
	_tableViewMy = [[UITableView alloc] initWithFrame:CGRectMake(0.0 , 64+30+20 ,DeviceWidth ,200) style:UITableViewStylePlain];
...
- (void)choose{
	...
	if (cellHeight>(DeviceHeight - 114)) {
		_tableViewMy.height = DeviceHeight - 114;
	}else{
