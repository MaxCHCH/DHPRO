...
- (void)viewDidLoad {
	...
	viewBtn.frame = CGRectMake(200, 100, 100, 50);
...
- (void)addView {
	...
	for (NSInteger i = 0; i < arr.count; i ++) {
		UILabel *label = [[UILabel alloc] initWithFrame:CGRectMake(0, 140 + 80 * i, self.view.frame.size.width, 20)];
		label.textAlignment = NSTextAlignmentCenter;
		label.text = arr[i];
		[self.view addSubview:label];
		
		CodeView *v = [[CodeView alloc] initWithFrame:CGRectMake(0, 160 + 80 * i, self.view.frame.size.width - 10, 60)
												  num:6
