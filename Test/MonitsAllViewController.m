...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
	...
	MonitSelectedViewController *MonitSelected = [[MonitSelectedViewController alloc]init];
	
	MonitSelected.tabNum = _tagString;
	
	[self presentViewController:MonitSelected animated:YES completion:nil];
}
...
-(UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath{
	...
	UIImageView *ima = [[UIImageView alloc]initWithImage:[UIImage imageNamed:@"wuyegonggao"]];
	cell.backgroundView = ima;
	UILabel *la = [[UILabel alloc]init];
	la.text = @"公司介绍";
	la.textAlignment = NSTextAlignmentCenter;
	la.font = [UIFont systemFontOfSize:14];
	la.frame = CGRectMake(cell.backgroundView.width/2, 100, cell.backgroundView.width, 15);
	cell.backgroundView = la;
