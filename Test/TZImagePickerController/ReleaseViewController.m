...
@interface ReleaseViewController ()<UITextFieldDelegate,UITextViewDelegate,TZImagePickerControllerDelegate,UICollectionViewDataSource,UICollectionViewDelegate>
...
- (void)UI{
    ...
    titleTextField.placeholder = @"请输入公告标题";
    ...
    [titleTextField addTarget:self action:@selector(textFieldDidChange11:) forControlEvents:UIControlEventEditingChanged];
    ...
    // textView
    textView = [[UITextView alloc] initWithFrame:CGRectMake(12, 14, self.view.frame.size.width - 24, 315/ 3)];
    //    textView.text = @"编辑公告内容";
    [textView setDelegate:self];
    textView.font = [UIFont systemFontOfSize:14];
    textView.returnKeyType = UIReturnKeyDefault;
    textView.keyboardType = UIKeyboardTypeDefault;
    //    textView.scrollEnabled = YES;  // 拖动
    ...
    jiamiLabel.frame = CGRectMake(12, 12, 64, 22);
    ...
    [textView addSubview:bianjiLabel];
