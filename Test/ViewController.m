...
//    [buttonName setFrame:CGRectMake(0, 64, 80, 20)];
//    buttonName.backgroundColor = [UIColor grayColor];       //背景颜
//    [buttonName setTitle:@"CustomCell" forState:UIControlStateNormal];
//    [buttonName addTarget:self action:@selector(hidenWithShowList) forControlEvents:(UIControlEventTouchUpInside)];
//    [self.view addSubview:buttonName];
//    
//    
//    UIButton *buttonImage = [UIButton buttonWithType:UIButtonTypeCustom];
//    [buttonImage setFrame:CGRectMake(85, 64, 80, 20)];
//    buttonImage.backgroundColor = [UIColor redColor];       //背景颜
//    [buttonImage setTitle:@"image" forState:UIControlStateNormal];
//    [buttonImage addTarget:self action:@selector(imageMedthod) forControlEvents:(UIControlEventTouchUpInside)];
//    [self.view addSubview:buttonImage];
//    
//    
//    UIButton *ImageButton = [UIButton buttonWithType:UIButtonTypeCustom];
//    [ImageButton setFrame:CGRectMake(170.0 ,64.0 ,80.0 ,20.0)];
...
//    [ImageButton addTarget:self action:@selector(imageGMedthod) forControlEvents:(UIControlEventTouchUpInside)];
//
//    [self.view addSubview:ImageButton];
//    
//    UIButton *AutoLayoutButton = [UIButton buttonWithType:UIButtonTypeCustom];
//    [AutoLayoutButton setFrame:CGRectMake(250.0 ,64.0 ,80.0 ,20.0)];
...
//    AutoLayoutButton.backgroundColor = [UIColor colorWithRed:1.00 green:1.00 blue:1.00 alpha:0.00];       //背景颜色
//    [AutoLayoutButton addTarget:self action:@selector(AutoLayoutViewControllerM) forControlEvents:(UIControlEventTouchUpInside)];
//    [self.view addSubview:AutoLayoutButton];
//    
//    UIButton *TZImagePickerButton = [UIButton buttonWithType:UIButtonTypeCustom];
//    [TZImagePickerButton setFrame:CGRectMake(330.0 ,64.0 ,60.0 ,20.0)];
//    [TZImagePickerButton setTitle:@"ReleaseView" forState:UIControlStateNormal];
//    [TZImagePickerButton setTitleColor:[UIColor blackColor] forState:(UIControlStateNormal)];
//    TZImagePickerButton.backgroundColor = [UIColor colorWithRed:1.00 green:1.00 blue:1.00 alpha:0.00];       //背景颜色
//    [TZImagePickerButton addTarget:self action:@selector(TZImagePickerControllerM) forControlEvents:(UIControlEventTouchUpInside)];
//    [self.view addSubview:TZImagePickerButton];
//    
//    
//    _button = [self button];
//    [_button setTitle:@"二维码" forState:(UIControlStateNormal)];
//   _button.frame = CGRectMake(3, 64+23, 50, 30);
//   [_button addTarget:self action:@selector(QRCodeMethod) forControlEvents:(UIControlEventTouchUpInside)];
//    
//    
//    _button = [self button];
//    [_button setTitle:@"导航栏" forState:(UIControlStateNormal)];
//    _button.frame = CGRectMake(65, 64+23, 50, 30);
//    [_button addTarget:self action:@selector(push) forControlEvents:(UIControlEventTouchUpInside)];
//    
//    _button = [self button];
//    [_button setTitle:@"导航栏" forState:(UIControlStateNormal)];
//    _button.frame = CGRectMake(125, 64+23, 50, 30);
//    [_button addTarget:self action:@selector(tabbar) forControlEvents:(UIControlEventTouchUpInside)];
//    
//    _button = [self button];
//    [_button setTitle:@"scrollCo" forState:(UIControlStateNormal)];
//    _button.frame = CGRectMake(180, 64+23, 50, 30);
//    [_button addTarget:self action:@selector(scrollContentOffSet) forControlEvents:(UIControlEventTouchUpInside)];
//    
//    _button = [self button];
//    [_button setTitle:@"TEAST" forState:(UIControlStateNormal)];
//    _button.frame = CGRectMake(180+50, 64+23, 50, 30);
