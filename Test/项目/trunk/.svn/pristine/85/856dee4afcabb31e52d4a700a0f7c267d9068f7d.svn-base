...
#import "NARUICollectionViewFlowLayout.h"

NSString *const WaterFallSectionHeader = @"WaterFallSectionHeader";
NSString *const WaterFallSectionFooter = @"WaterFallSectionFooter";

@interface NARUICollectionViewFlowLayout ()

@property (nonatomic, weak) id <NARLayoutDelegate> delegate;
...
@implementation NARUICollectionViewFlowLayout
...
- (void)prepareLayout
{
    ...
    self.delegate = (id <NARLayoutDelegate> )self.collectionView.delegate;
