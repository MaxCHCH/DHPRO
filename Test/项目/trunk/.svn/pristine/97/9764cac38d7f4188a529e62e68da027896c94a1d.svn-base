...
//        typeof(self) strongSelf = weakSelf;
        [weakSelf cancelCurrentImageDrag:NO];
        [weakSelf updateLayoutsForCurrentOrientation];
        [weakSelf updateDimmingViewForCurrentZoomScale:NO];
    } completion:^(id<UIViewControllerTransitionCoordinatorContext> context) {
        typeof(self) strongSelf = weakSelf;
        weakSelf.lastUsedOrientation = [UIApplication sharedApplication].statusBarOrientation;
...
//                typeof(self) strongSelf = weakSelf;
                JTSImageViewControllerFlags flags = weakSelf.flags;
                flags.isRotating = NO;
                weakSelf.flags = flags;
            }];
        }
