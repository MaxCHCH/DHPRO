...
@interface JYGroupView ()<UIScrollViewDelegate>{
...
#define color(r,g,b,a) [UIColor colorWithRed:(r)/255.0 green:(g)/255.0 blue:(b)/255.0 alpha:(a)]
        _pageControl.pageIndicatorTintColor = color(200, 200, 200, 0.8);//白色半透明
        //        _pageControl.currentPageIndicatorTintColor = color(45, 45, 45, 0.8);//灰色半透明
        _pageControl.currentPageIndicatorTintColor = ZDS_DHL_TITLE_COLOR;
