...
- (void)tileViews
{
    ...
    long lastNeededViewIndex  = floorf((CGRectGetMaxY(visibleBounds) / ROW_SPACE)) - 2;
...
- (UIToolbar *)toolbar:(NSString *)title {
    ...
    UIBarButtonItem *doneButton = [[UIBarButtonItem alloc] initWithTitle:@"完成" style:UIBarButtonItemStyleDone target:nil action:@selector(hidePicker)];
