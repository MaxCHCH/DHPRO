...
#define kFieldSize self.bounds.size
...
- (void)initView
{
    ...
    _passwordTextField = [[UITextField alloc] initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH - 48, 45)];
    ...
    CGFloat width = (SCREEN_WIDTH - 48) / kDotCount;
