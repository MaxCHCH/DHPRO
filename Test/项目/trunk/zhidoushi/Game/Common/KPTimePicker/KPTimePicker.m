...
//        [self addSubview:self.sunImage];
        ...
        self.confirmButton.frame = CGRectMake(80, 210, 2*kDefActualSize, 2*kDefActualSize);
...
//        self.confirmButton.center = self._centerPoint;
        ...
        self.timeSlider.frame = CGRectMake(90, 230, 160, 160);
...
//        [self addSubview:self.backButton];
        ...
        self.dayLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, 40, self.bounds.size.width, 120)];
        ...
        self.clockLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, 80, self.bounds.size.width, 120)];
