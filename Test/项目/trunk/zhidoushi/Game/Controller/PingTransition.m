...
- (void)animateTransition:(id <UIViewControllerContextTransitioning>)transitionContext{
    ...
    GroupTypeViewController * fromVC = (GroupTypeViewController *)[transitionContext viewControllerForKey:UITransitionContextFromViewControllerKey];
    CreateGroupTwoViewController *toVC = (CreateGroupTwoViewController *)[transitionContext viewControllerForKey:UITransitionContextToViewControllerKey];
    UIView *contView = [transitionContext containerView];

    UIButton *button = fromVC.creatBtn;
