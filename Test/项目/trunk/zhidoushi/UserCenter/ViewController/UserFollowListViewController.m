...
@interface UserFollowListViewController ()<UITableViewDelegate,UITableViewDataSource>
...
- (void)viewWillDisappear:(BOOL)animated
{
    ...
    [self.httpOpt cancel];
    [MobClick endLogPageView:@"关注页面"];
}
-(void)viewWillAppear:(BOOL)animated{
    
    [super viewWillAppear:animated];
    //友盟打点
    [MobClick beginLogPageView:@"关注页面"];
    //导航栏标题
...
-(void)loadDataWithIsMore:(BOOL)isMore{
    ...
    self.httpOpt = [WWRequestOperationEngine operationManagerRequest_Post:@"/user/followlist.do" parameters:dictionary requestOperationBlock:^(NSDictionary *dic) {
